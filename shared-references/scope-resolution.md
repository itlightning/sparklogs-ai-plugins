...
| `cnt_warning` .. `cnt_severe` | One count per failure-side band, 13 through 19 (the ladder is in `category-classes.md`) |
| `cnt_critical_plus` | Severity 20 and above. Rare, and fetch-first whatever the ticket was about |
