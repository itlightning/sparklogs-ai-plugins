...
| "How do I explore this kind of stream?" | `stream-kinds.md` | feed → kind → explore ladder. Not `fields.md` |
| "What does this `app` (LQL) token mean?" | `app-vocabulary.md` | pack-minted product identity; empty is normal |
