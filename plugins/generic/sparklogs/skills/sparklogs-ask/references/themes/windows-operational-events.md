...
Open `../feeds/<id>/reasons.md` and search for the reason. Same reason on two channels is one fact (example: `iis_worker_crash` System WAS / Application IIS).
...
Installed products: `device-health-and-state.md`.
