...
Job failed: `${CLAUDE_PLUGIN_ROOT}/playbooks/backup-failure.md` first; this file is the plumbing under the product.
...
Query both.
`${CLAUDE_PLUGIN_ROOT}/feeds/win.eventlog.application/{fields,reasons,enums}.md` and the System siblings.
...
8231 requester command line is message-tail `process_command_line`, not an LQL field.
