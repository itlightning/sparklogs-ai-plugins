...
Add `group_by: ["source"]` on `query_event_counts_by_severity` to turn any of these into the list of devices and how often each one matched.
...
Open monitor is not an incident (`../category-classes.md`).
