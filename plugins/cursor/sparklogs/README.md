...
- `commands/`: `/sparklogs-summary`, `/sparklogs-explain`. Ask, investigate, and analyze-cause are skills (plain language). Type the command, then the finding or investigation id after it.
