...
- `references/guides/stream-kinds.md` - how to explore a feed (Windows Event Log / WEL vs file log vs device-state maps). Not `fields.md`.
- `references/guides/app-vocabulary.md` - pack-minted `app` (LQL) product tokens. Empty is normal.
...
- `/sparklogs-summary <external_investigation_id>` - Re-displays the prior investigation summary.
- `/sparklogs-explain <claim or finding>` - Engineer asks the investigation skill to explain a specific Finding.
