...
Columns: `../device-state-fields.md`.
...
| Question | Surface |
|---|---|
| What is on the box / open condition in this window (episode-collapsed) | `query_device_health` (`fieldset` (arg) = `rca` for one host). Columns: `../device-state-fields.md` |
...
Open monitor ≠ incident (`../category-classes.md`).
