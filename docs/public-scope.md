...
- SparkLogs AI skills, commands, subagents, rules, and public references.
- Host plugin manifests and marketplace metadata.
- MCP configuration templates that point at SparkLogs-owned endpoints.
- Public installation, contribution, security, and maintainer docs.
- Public AI trust principles and public-facing product positioning.
...
When unsure, leave content in the private SparkLogs workspace and ask a maintainer to review before copying it here.
