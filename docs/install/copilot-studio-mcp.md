...
2. Add SparkLogs as a remote MCP server: https://mcp.sparklogs.app/
3. Configure the workspace-scoped SparkLogs API token using Copilot Studio's supported secret mechanism.
