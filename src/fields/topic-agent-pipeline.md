...
| `sparklogs.data.agent_pipeline.working_set_avg_mb` | float | megabytes | Sum of the agent and Vector mean resident working sets over the window. Includes available readings. |
