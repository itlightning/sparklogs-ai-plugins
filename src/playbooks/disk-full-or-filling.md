...
Monitor reasons encode the *claim*: `vol_os_space_exhausting` (value) is a projection to empty (projection fields present); a `near_cap` (other) reason is a level claim only.
