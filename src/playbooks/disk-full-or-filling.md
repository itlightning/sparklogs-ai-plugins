...
Monitor reasons encode the *claim*: `os_volume_space_exhausting` (value) is a projection to empty (projection fields present); a `near_cap` (other) reason is a level claim only.
