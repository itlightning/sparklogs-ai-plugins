...
| `win.eventlog.identity_security.ntlm_target_machine` | string | Machine this device authenticated OUT to over the legacy protocol, from the outbound ids (`TargetMachine`). Promoted on the outbound direction only, because which servers still accept the protocol is the question a retirement project asks. |
...
| `win.eventlog.identity_security.laps_http_status` | int | Status the directory service returned to a local administrator password backup, from LAPS 10059 (`Data1`). The field names on this provider are positional and the meaning of the first differs per id. |
...
| `win.eventlog.identity_security.sensor_http_error_code` | int | Transport or service error the endpoint sensor reported, from the SENSE contact and token ids (`errorCode` on some, `Int1` on others). A name that will not resolve is the dominant value. |
...
| `applocker_component_unavailable` / `default` | 8009 | **fields: none** |  |
...
| `defender_sensor_connection_failed` / `contact_failed` | 5, 67, 101, 405, 406, 409 | `win.eventlog.identity_security.sensor_contact_failures` `win.eventlog.identity_security.sensor_contact_successes` `win.eventlog.identity_security.sensor_http_error_code` `win.eventlog.identity_security.sensor_request_type` |  |
| `defender_sensor_connection_failed` / `name_resolution` | 5, 67, 101, 405, 406, 409 | `win.eventlog.identity_security.sensor_contact_failures` `win.eventlog.identity_security.sensor_contact_successes` `win.eventlog.identity_security.sensor_http_error_code` `win.eventlog.identity_security.sensor_request_type` |  |
| `defender_sensor_connection_failed` / `partial` | 5, 67, 101, 405, 406, 409 | `win.eventlog.identity_security.sensor_contact_failures` `win.eventlog.identity_security.sensor_contact_successes` `win.eventlog.identity_security.sensor_http_error_code` `win.eventlog.identity_security.sensor_request_type` |  |
...
| `entra_logon_failed` / `credential` | 1085, 1086, 1160, 1161, 1162 | **fields: none** |  |
| `entra_logon_failed` / `unexplained` | 1085, 1086, 1160, 1161, 1162 | **fields: none** |  |
| `entra_logon_failed` / `unreachable` | 1085, 1086, 1160, 1161, 1162 | **fields: none** |  |
...
| `exploit_mitigation_block` / `audit` | 1, 3, 11 | `win.eventlog.identity_security.mitigation_process` |  |
| `exploit_mitigation_block` / `designed_sandbox` | 2, 4, 6, 10, 12, 32, 34, 36 | `win.eventlog.identity_security.mitigation_process` |  |
| `exploit_mitigation_block` / `unexpected_caller` | 2, 4, 6, 10, 12, 32, 34, 36 | `win.eventlog.identity_security.mitigation_process` |  |
...
| `group_policy_cse_apply_failed` / `deferred` | 6016, 7016 | `win.eventlog.identity_security.gp_extension_id` `win.eventlog.identity_security.gp_extension_name` |  |
| `group_policy_cse_apply_failed` / `extension_failed` | 6016, 7016 | `win.eventlog.identity_security.gp_extension_id` `win.eventlog.identity_security.gp_extension_name` |  |
| `group_policy_cse_apply_failed` / `share_unreachable` | 6016, 7016 | `win.eventlog.identity_security.gp_extension_id` `win.eventlog.identity_security.gp_extension_name` |  |
...
| `laps_password_backup_failed` / `authentication` | 10005, 10026, 10028, 10032, 10059 | `win.eventlog.identity_security.laps_http_status` |  |
| `laps_password_backup_failed` / `backup_failed` | 10005, 10026, 10028, 10032, 10059 | `win.eventlog.identity_security.laps_http_status` |  |
| `laps_password_backup_failed` / `tenant_not_enabled` | 10005, 10026, 10028, 10032, 10059 | `win.eventlog.identity_security.laps_http_status` |  |
...
| `ntlm_authentication_used` / `legacy_version` | 4020, 4021, 4022, 4023 | `win.eventlog.identity_security.ntlm_channel_binding` `win.eventlog.identity_security.ntlm_mic_status` `win.eventlog.identity_security.ntlm_target_machine` `win.eventlog.identity_security.ntlm_usage_reason` `win.eventlog.identity_security.ntlm_version` |  |
| `ntlm_authentication_used` / `outbound` | 4020, 4021, 4022, 4023 | `win.eventlog.identity_security.ntlm_channel_binding` `win.eventlog.identity_security.ntlm_mic_status` `win.eventlog.identity_security.ntlm_target_machine` `win.eventlog.identity_security.ntlm_usage_reason` `win.eventlog.identity_security.ntlm_version` |  |
...
- `applocker_component_unavailable` / `default`
- `device_encryption_enable_failed` / `default`
- `entra_logon_failed` / `credential`
- `entra_logon_failed` / `unexplained`
- `entra_logon_failed` / `unreachable`
