...
| `log_collection_skipped_to_recover` | `rmm` | Error, or Warning when the collector gave up only a single record or boundary tick |  |
| `log_collection_stream_not_started` | `rmm` | Error |  |
| `log_delivery_failed` | `rmm` | Warning |  |

## `log_collection_feed_not_collecting`
...
## `log_collection_feed_unavailable`
...
## `log_collection_restarted_from_oldest`
...
## `log_collection_skipped_records_overwritten`
...
## `log_collection_skipped_to_recover`
...
## `log_collection_stream_not_started`
